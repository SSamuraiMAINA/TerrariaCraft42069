...
public class WoodLeavesBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:wood_leaves")
	public static final Block block = null;
	public WoodLeavesBlock(TerrrariaModElements instance) {
		super(instance, 4);
	}
