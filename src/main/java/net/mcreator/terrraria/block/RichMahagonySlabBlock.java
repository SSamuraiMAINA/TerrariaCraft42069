...
public class RichMahagonySlabBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:rich_mahagony_slab")
	public static final Block block = null;
	public RichMahagonySlabBlock(TerrrariaModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("rich_mahagony_slab");
		}
