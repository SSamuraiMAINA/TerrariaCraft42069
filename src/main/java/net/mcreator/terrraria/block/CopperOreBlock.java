...
import net.mcreator.terrraria.item.CopperIngotItem;
...
public class CopperOreBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TerrrariaModElements instance) {
		super(instance, 52);
	}
