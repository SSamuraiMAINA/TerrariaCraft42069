...
public class RichMahagonyLogBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:rich_mahagony_log")
	public static final Block block = null;
	public RichMahagonyLogBlock(TerrrariaModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rich_mahagony_log");
		}
