...
public class WoodFenceGateBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:wood_fence_gate")
	public static final Block block = null;
	public WoodFenceGateBlock(TerrrariaModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("wood_fence_gate");
		}
