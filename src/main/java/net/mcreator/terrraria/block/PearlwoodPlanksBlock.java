...
public class PearlwoodPlanksBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_planks")
	public static final Block block = null;
	public PearlwoodPlanksBlock(TerrrariaModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pearlwood_planks");
		}
