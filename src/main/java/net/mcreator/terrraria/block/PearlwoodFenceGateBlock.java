...
public class PearlwoodFenceGateBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_fence_gate")
	public static final Block block = null;
	public PearlwoodFenceGateBlock(TerrrariaModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("pearlwood_fence_gate");
		}
