...
public class WoodStairsBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:wood_stairs")
	public static final Block block = null;
	public WoodStairsBlock(TerrrariaModElements instance) {
		super(instance, 5);
	}
