...
public class RichMahagonyWoodBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:rich_mahagony_wood")
	public static final Block block = null;
	public RichMahagonyWoodBlock(TerrrariaModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rich_mahagony_wood");
		}
