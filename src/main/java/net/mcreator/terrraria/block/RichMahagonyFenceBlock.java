...
public class RichMahagonyFenceBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:rich_mahagony_fence")
	public static final Block block = null;
	public RichMahagonyFenceBlock(TerrrariaModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("rich_mahagony_fence");
		}
