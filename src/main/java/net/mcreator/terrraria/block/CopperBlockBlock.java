...
public class CopperBlockBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(TerrrariaModElements instance) {
		super(instance, 53);
	}
