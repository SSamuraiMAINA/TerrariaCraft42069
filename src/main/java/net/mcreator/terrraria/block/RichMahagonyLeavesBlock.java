...
public class RichMahagonyLeavesBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:rich_mahagony_leaves")
	public static final Block block = null;
	public RichMahagonyLeavesBlock(TerrrariaModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("rich_mahagony_leaves");
		}
