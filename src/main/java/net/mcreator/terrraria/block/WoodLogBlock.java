...
public class WoodLogBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:wood_log")
	public static final Block block = null;
	public WoodLogBlock(TerrrariaModElements instance) {
		super(instance, 2);
	}
