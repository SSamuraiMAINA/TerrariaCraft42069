...
public class WoodFenceBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:wood_fence")
	public static final Block block = null;
	public WoodFenceBlock(TerrrariaModElements instance) {
		super(instance, 7);
	}
