...
public class WoodWoodBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:wood_wood")
	public static final Block block = null;
	public WoodWoodBlock(TerrrariaModElements instance) {
		super(instance, 1);
	}
