...
public class PearlwoodWoodBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_wood")
	public static final Block block = null;
	public PearlwoodWoodBlock(TerrrariaModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pearlwood_wood");
		}
