...
public class PearlwoodStairsBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_stairs")
	public static final Block block = null;
	public PearlwoodStairsBlock(TerrrariaModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pearlwood_stairs");
		}
