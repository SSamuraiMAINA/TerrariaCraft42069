...
public class PearlwoodSlabBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_slab")
	public static final Block block = null;
	public PearlwoodSlabBlock(TerrrariaModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pearlwood_slab");
		}
