...
public class RichMahagonyPlanksBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:rich_mahagony_planks")
	public static final Block block = null;
	public RichMahagonyPlanksBlock(TerrrariaModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rich_mahagony_planks");
		}
