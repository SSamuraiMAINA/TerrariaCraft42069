...
public class PearlwoodLogBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_log")
	public static final Block block = null;
	public PearlwoodLogBlock(TerrrariaModElements instance) {
		super(instance, 34);
	}
