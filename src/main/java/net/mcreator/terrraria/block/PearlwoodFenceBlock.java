...
public class PearlwoodFenceBlock extends TerrrariaModElements.ModElement {
	@ObjectHolder("terrraria:pearlwood_fence")
	public static final Block block = null;
	public PearlwoodFenceBlock(TerrrariaModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("pearlwood_fence");
		}
